...
while run_global:
    ...
    while run_option:
        ...
        pygame.draw.rect(ecran, rouge, (100, 300, 600, 50), 2)  # Barre du curseur
        pygame.draw.rect(ecran, orange, (100 + param_value * 6, 300, 2, 50))  # Curseur
        value_text = font.render("Son: " + str(int(param_value)), True, rouge)  # Utilisation de la police pour le texte
        ecran.blit(value_text, (250, 400))  # Utilisation de ecran au lieu de screen pour le texte
